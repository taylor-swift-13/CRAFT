# RQ3: SFT and RL training stages
...
- `paper_summaries/` contains the selected RL configuration, the Qwen3-8B
  ...
  evaluation used by the SFT+RL tables.
- `intermediate/` is reserved for regenerated curation intermediates and is
  not required to compile the paper.
