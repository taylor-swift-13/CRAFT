...
at one- and eight-response budgets. RL denotes training from Bare;
...
For Bare Qwen3-8B, pass@1 is 6.37\%,
...
\caption{Qwen3-8B verification across sampling budgets, with RL initialized from (a) Bare and (b) SFT.}
\label{fig:rl-panels}
\end{minipage}
\end{figure}
...
SFT reaches 63.94\% compose@1, exceeding Bare compose@32 (57.81\%).
...
\captionsetup{font=small,margin={7pt,0pt}}
\caption{Qwen3-8B reward ablation from Bare: (a) pass@\(k\); (b) compose@\(k\). Vertical scales differ.}
