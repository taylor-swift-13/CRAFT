...
Training evaluates individual rollouts, their union, and repaired pools to
assign generation and refinement credit.  Standalone rejection measures
strength, while group-relative hardness rewards trace units rejected by few
other rollouts.  The only redundancy cost applies to conservative semantic
duplicates; unique clauses are never punished merely for overlapping sampled
coverage.
