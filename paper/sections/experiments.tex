...
Meanwhile, post-SFT RL lowers pass@1 from 41.95\% to 36.78\%.
...
(Figure~\ref{fig:reward-ablation}).  Binary alone reaches only 4.45\%
compose@32.  Whole-rollout adds coverage but gates credit on the entire
response: compose@32 falls to 23.32\%, even as pass@1 improves to 15.50\%,
below Base's 57.81\%.  One rejected clause therefore withholds credit from
...
1.68 points. The full comparison is in Appendix~\ref{app:full-credit-analysis}.
