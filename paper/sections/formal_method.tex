...
\(n\) saved responses.  Pass@\(n\) measures standalone success at the
same nominal budget; archived results estimate it over subsets of the saved pool
...
coverage credit.  The per-response cap limits admission without penalizing
excess output.
