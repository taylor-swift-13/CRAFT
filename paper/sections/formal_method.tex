...
We retain the notation of Definition~\ref{def:method-task} and expand its
semantics here.  Let \(\Sigma\) be the program-state space.  A loop is
...
\begin{equation}
  ...
  \qquad I(\varnothing)=\mathsf{true}.
