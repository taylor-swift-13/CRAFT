...
\noindent
This supplement reports analyses that are useful for assessing robustness,
systems cost, and design sensitivity but are not required for the main
argument.  Appendix~A tests whether duplicate instances within the evaluation
...
All training and inference settings are held fixed across repetitions;
only the independent runs differ.  This yields nine
