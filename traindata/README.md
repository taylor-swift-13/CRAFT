...
| `craft_sft_archive.json` | sanitized SFT archive (3,096 rows) — source of archival answers | released artifact |
...
python paper/scripts/canonicalize_training_pool.py sft --input traindata/craft_sft_archive.json    --output traindata/craft_sft_canonical.json   --report /tmp/sft_canon.json
