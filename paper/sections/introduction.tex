...
verification.  A final postcondition may not directly guide an intermediate
loop when other loops or function calls follow it.  A strong
...
complete a proof.  Compositional inference substantially improves bare-model
verification, and aligned training yields further gains.  Our primary metric
is compose@1, the verification rate after filtering and composing one response.
...
\begin{itemize}
  ...
  identifies the contributions rewarded by RL. With one response, bare
