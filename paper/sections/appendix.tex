...
The request flag \texttt{use\_marginal=false} implements the marginal
ablation without paying for leave-one-rollout-out prover calls.
...
rollout dumps and exposes \texttt{--disable-marginal}.
